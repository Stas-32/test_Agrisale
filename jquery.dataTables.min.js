...
sNext:"След.",sPrevious:"Пред."},sEmptyTable:"Нет позиций",sInfo:"Отображено с _START_ по _END_ из _TOTAL_ позиций",sInfoEmpty:"Нет позиций",sInfoFiltered:"(Отфильтровано из _MAX_ позиций)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показывать по _MENU_ позиций",sLoadingRecords:"Загрузка...",sProcessing:"Обработка...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"По вашему запросу позиций не найдено"},oSearch:l.extend({},u.models.oSearch),sAjaxDataProp:"data",
